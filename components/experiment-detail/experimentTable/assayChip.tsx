...
const AssayChip: React.FC<AssayChipProps> = (props: AssayChipProps) => {
    const { data: experimentInfo } = useExperimentInfo(props.assay.experimentId);
    ...
    const getResultText = (assayTypesForExperiment : AssayTypeInfo[]) : string => {
        const units: string = getAssayTypeUnits(props.assay.assayTypeId, assayTypesForExperiment);
            ...
            >
                <Stack sx={{ margin: -0.25 }}>
                    <Typography sx={{ fontSize: 16 }}>
                        {assayTypeIdToName(props.assay.assayTypeId, experimentInfo.assayTypes)}
                    </Typography>
                    <Typography sx={{ fontSize: 12 }}>{getResultText(experimentInfo.assayTypes)}</Typography> 
                    <Box
                        sx={{
                            marginY: -0.25,
                            display: "flex",
