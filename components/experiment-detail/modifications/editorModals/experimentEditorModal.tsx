        ...
        >
            <Stack>
                <TextField
                    ...
                    style={{ marginBottom: 8, marginLeft: 4, marginRight: 4 }}
                ></TextField>
                <TextField
                ...
                {checkIfAnAssayHasResults(data, () => true) ? (
                    <Typography>
                        Cannot modify the start date, because assay results have
                        been recorded
                    </Typography>
                ) : (
                    <MyDatePicker
                ...
                <ButtonWithLoadingAndError
                    ...
                    onSubmit={() => {
                        updateExperiment({
                            ...
                            newDescription,
                            newStartDate,
                            shouldUpdateStartDate: !checkIfAnAssayHasResults(
                                data,
                                () => true
                            ),
