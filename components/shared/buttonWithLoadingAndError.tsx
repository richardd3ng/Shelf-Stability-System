...
export const YourButtonWithLoadingAndError: React.FC<
    YourButtonWithLoadingAndErrorProps
> = (props: YourButtonWithLoadingAndErrorProps) => {
    return (
        <>
            {props.children}
            <LoadingAndError
...
export const LoadingAndError: React.FC<LoadingAndErrorProps> = (
    ...
    return (
        <>
            ...
            {props.isError ? (
                <ErrorMessage message={getErrorMessage(props.error)} />
            ) : null}
        </>
    );
};
