...
export const useExperimentInfo = (experimentId : number) : UseQueryResult<ExperimentInfo> => {
    return useQuery<ExperimentInfo>(getQueryKeyForUseExperimentInfo(experimentId), () => fetchExperimentInfoThroughAPI(experimentId));
}
        ...
        onSuccess : (newResultInfo) => {
            if (experimentData){
                ...
                if (assay){
                    ...
                    queryClient.setQueryData(getQueryKeyForUseExperimentInfo(experimentId), newExperimentData)
                }
            }
