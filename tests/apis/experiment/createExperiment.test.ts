...
import createExperimentAPI from '@/pages/api/experiments/create';
...
describe('/api/experiment/create', () => {
    ...
    it('rejects request from non-admin', async () => {
        ...
        await createExperimentAPI(req as NextApiRequest, res as NextApiResponse);
